...
type SanitizedBlock = { type: string; title: string; body: string; imageKey?: string; side?: 'left' | 'right'; heightPx?: number; colSpan?: number; zone?: 'left' | 'right' | 'bottom' };
  ...
  return input
    ...
    .map((b): SanitizedBlock => ({
      ...
      ...(typeof b.colSpan === 'number' && Number.isFinite(b.colSpan)
        ...
        : {}),
      ...(b.zone === 'left' || b.zone === 'right' || b.zone === 'bottom' ? { zone: b.zone } : {}),
    }));
}
