// Duplicated from ../../../functions/_lib/basic-auth.ts, not imported —
// this project deploys from within dev-landing/ as its own root (see
// .github/workflows/deploy-dev.yml's "Deploy landing page" step), so it
// can't reach the main app's functions/ directory. Keep both in sync.
//
